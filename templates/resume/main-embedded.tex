...
% ====================== 简介 ======================
\noindent 西北工业大学控制工程专业硕士在读（2027年6月毕业），求职方向为\hl{嵌入式开发 / 机器人系统研发}。熟练使用 \hl{C/C++、STM32、FreeRTOS、Linux 与 ROS/ROS2}，具备覆盖\hl{算法与部署、软件开发、电路设计与嵌入式系统开发}的全流程研发能力，了解机器人机械结构与系统集成基础。参与国家级重点机器人课题，并在具身智能实习中完成双臂机器人 ROS2 系统、固件级 IK 与实时推理部署；累计 \hl{6 项专利（4 发明 / 2 实用新型）}与 \hl{2 项软件著作权}。
...
\begin{itemize}
  ...
  \item \textbf{工程工具}: Git、Linux、WebSocket、Inventor 3D 建模与多模块系统联调
\end{itemize}
...
\begin{itemize}
  ...
  \item 基于 \hl{MuJoCo} 搭建轮式仿人机器人仿真环境；开发\hl{自研双臂与底盘电机控制系统}，完成执行机构控制与整机联调
...
\begin{itemize}
  \item 主导智能葫芦灸、温针理疗仪、家用移动灸罐三代产品的\hl{电子与软件系统研发}（电路 / PCB → 嵌入式软件 → 上位机），参与机械结构方案讨论与系统集成
...
[\textnormal{VLA 与世界模型实习生 · 机器人系统与端侧 AI}]
[2026.04—至今]
...
\begin{itemize}
  ...
  \item 完成 \hl{RECAP / RLT 在美甲操作任务}上的应用实现，适配训练与评测链路
\end{itemize}
